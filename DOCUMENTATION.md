...
## type [CreateCheckoutBody](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L517-L563>)
...
## type [CreateCheckoutBodyPurpose](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L567>)
...
## type [CreateCheckoutBodyStatus](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L576>)
...
## type [CreateCheckoutBodyTransaction](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L585-L617>)
...
## type [CreateCheckoutBodyTransactionStatus](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L620>)
...
## type [GetPaymentMethodsParams](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L679-L685>)
...
### func \(\*GetPaymentMethodsParams\) [QueryValues](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L688>)
...
## type [ListCheckoutsParams](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L662-L665>)
...
### func \(\*ListCheckoutsParams\) [QueryValues](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L668>)
...
## type [ProcessCheckoutBody](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L630-L648>)
...
## type [ProcessCheckoutBodyPaymentType](<https://github.com/sumup/sumup-go/blob/main/checkouts/checkouts.go#L651>)
...
## type [CreateCustomerBody](<https://github.com/sumup/sumup-go/blob/main/customers/customers.go#L63-L68>)
...
## type [UpdateCustomerBody](<https://github.com/sumup/sumup-go/blob/main/customers/customers.go#L71-L74>)
...
## type [GetTransactionParams](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L534-L542>)
...
### func \(\*GetTransactionParams\) [QueryValues](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L545>)
...
## type [GetTransactionV21Params](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L661-L673>)
...
### func \(\*GetTransactionV21Params\) [QueryValues](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L676>)
...
## type [ListTransactionsParams](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L443-L476>)
...
### func \(\*ListTransactionsParams\) [QueryValues](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L479>)
...
## type [ListTransactionsV21Params](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L564-L599>)
...
### func \(\*ListTransactionsV21Params\) [QueryValues](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L602>)
...
## type [RefundTransactionBody](<https://github.com/sumup/sumup-go/blob/main/transactions/transactions.go#L436-L440>)
...
```go
import "github.com/sumup/go-sdk-gen/internal/strcase"
```
...
<a name="MakePlural"></a>
## func [MakePlural](<https://github.com/sumup/sumup-go/blob/main/codegen/internal/strcase/strings.go#L25>)
...
## func [MakeSingular](<https://github.com/sumup/sumup-go/blob/main/codegen/internal/strcase/strings.go#L17>)
...
<a name="ToCamel"></a>
## func [ToCamel](<https://github.com/sumup/sumup-go/blob/main/codegen/internal/strcase/strings.go#L36>)

```go
func ToCamel(s string) string
```

ToCamel converts the provided string into CamelCase and ensures well\-known initialisms stay capitalized \(e.g. app\_id \-\> AppID\).

<a name="ToLowerCamel"></a>
## func [ToLowerCamel](<https://github.com/sumup/sumup-go/blob/main/codegen/internal/strcase/strings.go#L52>)

```go
func ToLowerCamel(s string) string
```

ToLowerCamel converts the provided string into lowerCamelCase with the same initialism handling as [ToCamel](<#ToCamel>).

<a name="ToLowerFirstLetter"></a>
## func [ToLowerFirstLetter](<https://github.com/sumup/sumup-go/blob/main/codegen/internal/strcase/strings.go#L9>)
...
<a name="ToSnake"></a>
## func [ToSnake](<https://github.com/sumup/sumup-go/blob/main/codegen/internal/strcase/strings.go#L68>)

```go
func ToSnake(s string) string
```

ToSnake converts any supported string into snake\_case.
...
<a name="New"></a>
### func [New](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/builder.go#L57>)
...
### func \(\*Builder\) [Build](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/builder.go#L104>)
...
### func \(\*Builder\) [Load](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/builder.go#L85>)
...
<a name="Config"></a>
## type [Config](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/builder.go#L46-L51>)
...
### func \(\*EnumDeclaration\[E\]\) [String](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/types.go#L95>)
...
<a name="Method"></a>
## type [Method](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/methods.go#L29-L39>)
...
### func \(Method\) [ParamsString](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/methods.go#L41>)
...
### func \(\*OneOfDeclaration\) [String](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/types.go#L39>)
...
<a name="Option"></a>
## type [Option](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/builder.go#L53>)
...
<a name="Parameter"></a>
## type [Parameter](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/methods.go#L23-L26>)
...
## type [ResponseType](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/methods.go#L226-L229>)
...
### func \(\*StructField\) [String](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/types.go#L57>)
...
### func \(\*TypeDeclaration\) [String](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/types.go#L18>)
...
<a name="Writable"></a>
## type [Writable](<https://github.com/sumup/sumup-go/blob/main/codegen/pkg/builder/types.go#L14-L16>)
