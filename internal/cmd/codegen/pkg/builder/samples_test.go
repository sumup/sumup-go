...
func TestBuilder_Samples(t *testing.T) {
	t.Parallel()

	repositoryRoot, catalog, expectedSamples := testSampleCatalog(t)
	t.Run("catalog metadata and unique sorted samples", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("uses request examples and Go literals", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("portal JSON contract", func(t *testing.T) {
		t.Parallel()
		encodedSample, err := json.Marshal(sampleByID(t, catalog.Samples, "CreateCheckout.HostedCheckout"))
		if err != nil {
	...
	t.Run("compiled examples", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("deterministic output", func(t *testing.T) {
		...
		firstJSON, err := json.Marshal(catalog)
		if err != nil {
...
func TestSampleRenderer_value(t *testing.T) {
	t.Parallel()
	...
	t.Run("request example takes precedence", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("property examples without request example", func(t *testing.T) {
		t.Parallel()
		renderer := sampleRenderer{
			registry: sampleTypeRegistry{"Request": declaration},
			imports:  make(map[string]struct{}),
