...
func (s *CheckoutsService) Get(ctx context.Context, params ListCheckoutsParams) (*ListCheckoutsResponse, error) {
...
// GetCheckouts: Retrieve a checkout
...
func (s *CheckoutsService) GetCheckouts(ctx context.Context, id string) (*CheckoutSuccess, error) {
	path := fmt.Sprintf("/v0.1/checkouts/%v", id)
